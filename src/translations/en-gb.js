...
const messages = {
    ...
    noPropertyMessage: 'You have not added any property so far, please',
    add: 'add',
    noPropertyMessageEnd: 'property.',
    ...
    noContentAvailablePublic: 'We currently have no videos to display.',
    ...
    invalidVideoUpload: 'Please select a valid video file.',
    addTags: 'Add Tags',
    ...
    cookiesLi2: 'The Help feature on most browsers will tell you how to prevent your browser from accepting new cookies, how to have the browser notify you when you receive a new cookie, or how to disable cookies altogether. Because cookies allow you to take advantage of some of essential features of our Services, we recommend that you leave them turned on. For instance, if you block or otherwise reject our cookies, you will not be able to _______',
    ...
    heading3Li2Content: 'Sometimes we send offers to selected groups of Welcome Systems members on behalf of other businesses. When we do this, we do not give that business your name and address. If you do not want to receive such offers, please send an email to privacy@welcomesystems.com.',
    ...
    heading6Content: 'We provide you with the ability to edit the information in your user account information that you provided to us in registration by using your personal page configuration area. You may request deletion of your user account by ______________. Content or other Personal Information that you may have provided to us and that is not contained within your user account, such as videos uploaded by you, may continue to remain on our Service at our discretion even though your user account is deleted.',
    ...
    heading7Li3Content: 'If you do not wish to receive promotional offers from our partners, and do not wish to participate in any other internet-based ad programs, please opt out by sending us an email to privacy@welcomesystems.com. We will keep track of your decision in our database. Even if you choose not to receive information from us, we reserve the right to communicate with you on matters we consider especially important relating to our products or services or relating to your account.',
    ...
    heading10Content: 'If you have any questions about this Policy or our web site, please feel free to contact our webmaster at ________[email]_______. We will provide an Unsubscribe method in any email we send to you.',
  ...
  //  ---------Terms of service----------------
    ...
    'Policy, found at (LINK) and incorporated herein by reference. If you do not agree ' +
    ...
    'Systems by logging into your account on our login page (Link). Some ' +
    'promotional memberships are offered by third parties in conjunction with the ' +
    ...
    'ON THE WELCOME SYSTEMS LOGIN PAGE (Link) TO FIND CANCELLATION ' +
    ...
    'that date. Your renewal date may change due to changes in your Membership. ' +
    'Visit our login page (Link) and login to your account to see the commencement ' +
    ...
    'to your account on the login page (Link), and clicking on the “Upgrade Plan” link. ' +
    ...
    'MEMBERSHIP PERIODS OR UNWATCHED MOVIES OR TV SHOWS. To ' +
    'cancel, login to your account on our login page (Link) and click on the “Cancel ' +
    'Plan” link.',
    ...
    'to _______________ [Need to designate Copyright Agent]. ',
    ...
    'or if you need assistance with your account, please visit_________. In certain ' +
    'instances, Customer Service may best be able to assist you by using a remote ' +
